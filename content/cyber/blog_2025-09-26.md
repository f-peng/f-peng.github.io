...
## Introduction courte
Le secteur aérien européen a été bousculé par une cyberattaque via un prestataire tiers, entraînant annulations et retards, tandis qu’en France l’organisme France Travail dément une nouvelle fuite massive et la justice lyonnaise sanctionne lourdement une affaire emblématique. À l’international, administrations et industriels restent sous pression, sur fond d’alertes produits visant notamment Cisco, Chrome et Nagios.

## 🇫🇷 En France
- France Travail: dément tout nouveau piratage malgré la revendication d’un hacker évoquant 22,3 millions de dossiers, dont des NIR [01net](https://www.01net.com/actualites/france-travail-dement-avoir-subi-nouvelle-fuite-donnees.html).
- Justice lyonnaise (affaire Adecco): prononce de lourdes peines dans un dossier emblématique de piratage [ZDNet](https://www.zdnet.fr/actualites/de-lourdes-peines-prononcees-au-proces-du-piratage-dadecco-482727.htm#xtor=RSS-1).

## 🌍 À l’international
- Brussels Airport et plusieurs hubs européens: annulations et retards après compromission d’un service tiers; la cause a été identifiée par l’ENISA [01net](https://www.01net.com/actualites/cyberattaque-contre-plusieurs-aeroports-europe-que-passe-weekend.html), [Siècle Digital](https://siecledigital.fr/2025/09/26/on-connait-desormais-lorigine-de-la-cyberattaque-qui-a-cloue-des-avions-au-sol/), [YouTube](https://www.youtube.com/shorts/qNX5IVt8KBg).
- Maryland Department of Transportation (États-Unis): le groupe Rhysida revendique une attaque, données mises en vente pour 3,4 M$ en Bitcoin [The Currency Analytics](http://www.bing.com/news/apiclick.aspx?ref=FexRss&aid=&tid=68d7c5286afb439caeab68dd7d7932de&url=https%3a%2f%2ffr.thecurrencyanalytics.com%2fbitcoin-fr%2fles-hackers-ciblent-le-departement-des-transports-du-maryland-vendent-des-donnees-pour-34-millions-de-dollars-en-bitcoin-200605&c=10947965928362140217&mkt=fr-fr).
- Cisco: défaut de validation des entrées dans les services web de Secure Firewall ASA/FTD/IOS/IOS XE/IOS XR, ouvrant la voie à des attaques dont certaines sans authentification (ASA/FTD) [Cyberveille eSanté](https://cyberveille.esante.gouv.fr/alertes/cisco-cve-2025-20363-2025-09-26).
- Google Chrome: vulnérabilité dans V8 permettant l’exécution de code via un site piégé [Cyberveille eSanté](https://cyberveille.esante.gouv.fr/alertes/google-chrome-cve-2025-10892-2025-09-26).
- Nagios: injection de commandes dans plusieurs assistants (MongoDB/MySQL/Postgres) exploitable par un utilisateur à privilèges élevés [Cyberveille eSanté](https://cyberveille.esante.gouv.fr/alertes/nagios-cve-2025-34227-2025-09-26).
- Thermofin (Allemagne): victime d’une cyberattaque autour du 23 septembre 2025 [Valéry Marchive (Bluesky)](https://bsky.app/profile/valerymarchive.bsky.social/post/3lzpv6vs2pp2t).
...
## Conclusion
La chaîne d’approvisionnement informatique confirme son rôle de maillon faible avec l’incident aérien européen, tandis que les campagnes d’extorsion touchent toujours des administrations et l’industrie. Priorités immédiates: renforcer la gestion des risques tiers, appliquer sans délai les correctifs sur les technologies exposées (réseaux, navigateurs, supervision) et maintenir des capacités de réponse aux incidents adaptées aux attaques opportunistes comme ciblées.

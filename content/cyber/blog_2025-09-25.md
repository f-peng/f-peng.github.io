...
## Introduction
La journée confirme deux tendances lourdes : des attaques de la chaîne d'approvisionnement qui paralysent des secteurs industriels clés et une alerte nationale sur des vulnérabilités réseau Cisco activement exploitées, poussant autorités et opérateurs à prioriser correctifs et résilience des fournisseurs.

## 🇫🇷 En France
- CERT‑FR signale des vulnérabilités Cisco (dont CVE‑2025‑20362 et CVE‑2025‑20333) activement exploitées permettant l'exécution de code à distance sur ASA/FTD, appelant à des mesures immédiates de détection et de mitigation ([CERT‑FR — Alerte](https://www.cert.ssi.gouv.fr/alerte/CERTFR-2025-ALE-013/), [CERT‑FR — Avis](https://www.cert.ssi.gouv.fr/avis/CERTFR-2025-AVI-0819/)).  
- Des avis techniques et bulletins français détaillent plusieurs vulnérabilités dans Cisco IOS/IOS XE et recommandent le déploiement des correctifs fournis par l'éditeur ([CERT‑FR — Avis](https://www.cert.ssi.gouv.fr/avis/CERTFR-2025-AVI-0818/), [Cyberveille — Cisco CVE-2025-20334](https://cyberveille.esante.gouv.fr/alertes/cisco-cve-2025-20334-2025-09-25)).  
- Le laboratoire médical Inovie Labosud est indiqué comme victime d'une cyberattaque locale, illustrant l'impact sur les services de santé de proximité ([Hérault Tribune via flux social](https://www.herault-tribune.com/articles/herault-le-laboratoire-medical-inovie-labosud-frappe-par-une-cyberattaque/)).  
- L'Arcep et les acteurs du mobile font face à la préparation de l'extinction des réseaux 2G/3G en France, une transition technique qui mobilise les opérateurs et pose des enjeux de continuité pour certains équipements ([CyberLettre 406](https://cyberveille.curated.co/issues/406)).

## 🌍 À l’international
- Jaguar Land Rover (Royaume‑Uni) paralysé par une cyberattaque majeure ; le gouvernement britannique envisage d'acheter des pièces aux sous‑traitants pour éviter des faillites et préserver des emplois ([Le Monde](https://www.lemonde.fr/economie/article/2025/09/25/cyberattaque-geante-contre-jaguar-land-rover-le-gouvernement-britannique-pret-a-soutenir-les-fournisseurs-du-constructeur-paralyse_6642916_3234.html)).  
- Volvo victime collatérale d'un ransomware via un fournisseur logiciel, compromettant les données d'employés nord‑américains et soulignant la montée des attaques sur la chaîne d'approvisionnement ([01net](https://www.01net.com/actualites/apres-jaguar-land-rover-stellantis-volvo-victime-fuite-donnees.html)).  
- Le transporteur historique KnP Logistics Group a dû cesser ses activités après une cyberattaque liée à un mot de passe trop faible, conséquence directe sur la pérennité d'entreprises traditionnelles ([Clubic](https://www.clubic.com/actualite-580699-apres-plus-de-150-ans-cette-societe-a-mis-la-cle-sous-la-porte-a-cause-d-un-mot-passe-trop-faible.html)).  
- Des perturbations dans plusieurs aéroports européens ont été liées à une attaque visant Collins Aerospace, mettant en lumière les risques systémiques liés aux fournisseurs de l'aviation civile ([CyberLettre 406](https://cyberveille.curated.co/issues/406)).  
- Une campagne Akira ransomware a exploité un outil de gestion à distance (RMM) pour lancer un chiffrement, démontrant la tactique "living off the land" et l'usage d'outils légitimes pour échapper à la détection ([Barracuda Blog FR](https://fr.blog.barracuda.com/2025/09/25/soc-case-files-akira-ransomware-remote-management-tool)).  
- L'Agence du revenu du Canada (ARC) signale la compromission de plus de 881 000 numéros de téléphone d'utilisateurs, impactant la confidentialité d'un large volume de données personnelles ([TVA Nouvelles](https://www.tvanouvelles.ca/2025/09/25/cyberattaque-plus-de-881-000-numeros-de-telephone-dutilisateurs-de-larc-pirates?utm_source=flipboard&utm_content=topic%2Ffr-cybercriminalit%C3%A9)).  
- Check Point Research / analyses journalistiques mettent en lumière PureCoder, un acteur professionnel du développement de malwares qui contribue à la professionnalisation de la cybercriminalité mondiale ([CYBER‑SECURITE.FR](https://www.cyber-securite.fr/purecoder-developpeur-malware/)).  
- En Italie, le dispositif "Piracy Shield" (initialement pour le football) s'étend pour bloquer d'autres événements diffusés en direct, montrant la diffusion d'outils anti‑piratage à large échelle ([Clubic](https://www.clubic.com/actualite-580696-iptv-pirate-apres-le-football-un-nouveau-terrain-vise-par-cette-fameuse-arme-antipiratage.html)).
...
## Conclusion
La période met en exergue deux priorités opérationnelles : corriger en urgence les vulnérabilités réseau signalées par les autorités (notamment Cisco/ASA/FTD) et renforcer la résilience de la chaîne d'approvisionnement — tant technique (patching, segmentation, surveillance des outils RMM) qu'économique (soutien aux fournisseurs critiques). Pour les équipes sécurité, la surveillance des exploits en cours et la validation rapide des mesures de mitigation restent essentielles.

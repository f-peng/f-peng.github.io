...
## Introduction courte
Gros plan sur la supply chain: l’automobile et l’aérien paient un lourd tribut aux attaques indirectes, pendant que Cisco affronte plusieurs failles activement exploitées. Ransomware opportunistes, vulnérabilités réseau et confusion autour de fuites supposées d’organismes publics composent un paysage où la réactivité et la gestion de tiers redeviennent prioritaires.

## 🇫🇷 En France
- CERT-FR — Alerte sur des failles Cisco ASA/FTD activement exploitées permettant une exécution de code à distance sans authentification (CVE-2025-20362, CVE-2025-20333). Sources: [CERT-FR](https://www.cert.ssi.gouv.fr/alerte/CERTFR-2025-ALE-013/), [CERT-FR (Mastodon)](https://social.numerique.gouv.fr/@cert_fr/115266136468526536), [CERT-FR (Bluesky)](https://bsky.app/profile/cert-fr.bsky.social/post/3lzoiebdbm62k)
- ANTS — Une enquête démonte la « mascarade » de ventes massives de données prétendument issues de l’agence. Source: [ZATAZ](https://cur.at/dCUWylR?m=rss)
- Inovie Labosud — Le laboratoire médical frappé par une cyberattaque fin août, impacts en cours d’évaluation. Source: [Hérault Tribune](https://www.herault-tribune.com/articles/herault-le-laboratoire-medical-inovie-labosud-frappe-par-une-cyberattaque/)

## 🌍 À l’international
- Jaguar Land Rover — Les usines à l’arrêt après une cyberattaque d’ampleur; Londres envisage un soutien direct aux fournisseurs pour préserver l’emploi. Source: [Le Monde](https://www.lemonde.fr/economie/article/2025/09/25/cyberattaque-geante-contre-jaguar-land-rover-le-gouvernement-britannique-pret-a-soutenir-les-fournisseurs-du-constructeur-paralyse_6642916_3234.html)
- Volvo — Fuite de données d’employés nord-américains via un fournisseur logiciel, illustrant le risque supply chain. Source: [01net](https://www.01net.com/actualites/apres-jaguar-land-rover-stellantis-volvo-victime-fuite-donnees.html)
- KnP Logistics Group — Transporteur britannique de 150 ans contraint à la fermeture après une cyberattaque facilitée par un mot de passe faible. Source: [Clubic](https://www.clubic.com/actualite-580699-apres-plus-de-150-ans-cette-societe-a-mis-la-cle-sous-la-porte-a-cause-d-un-mot-passe-trop-faible.html)
- Aéroports européens / Collins Aerospace — Retards et annulations en chaîne après une attaque chez un fournisseur critique de l’aviation. Sources: [Numerama](https://cur.at/YCOxhWG?m=rss), [L’Usine Digitale](https://news.google.?oc=5)
- Cisco — Multiples vulnérabilités dans IOS/IOS XE et d’autres produits, dont une zero-day SNMP et des failles ASA/FTD activement exploitées; correctifs et guides publiés. Sources: [CERT-FR (AVI-0818)](https://www.cert.ssi.gouv.fr/avis/CERTFR-2025-AVI-0818/), [CERT-FR (AVI-0819)](https://www.cert.ssi.gouv.fr/avis/CERTFR-2025-AVI-0819/), [CERT-FR (Alerte)](https://www.cert.ssi.gouv.fr/alerte/CERTFR-2025-ALE-013/), [IT-Connect](https://www.it-connect.fr/cisco-ios-13-vulnerabilites-dont-1-faille-zero-day-snmp/)
- Google Chrome — Failles V8 permettant l’exécution de code à la visite d’un site piégé. Source: [Cyberveille e-santé](https://cyberveille.esante.gouv.fr/alertes/google-chrome-cve-2025-10891-2025-09-25)
- Microsoft — OmniParser vulnérable à une exécution de code via liaison à une IP non restreinte. Source: [Cyberveille e-santé](https://cyberveille.esante.gouv.fr/alertes/microsoft-omniparser-cve-2025-55322-2025-09-25)
- Node.js — La librairie counterpart vulnérable à des requêtes malicieuses menant potentiellement à des abus. Source: [Cyberveille e-santé](https://cyberveille.esante.gouv.fr/alertes/nodejs-cve-2025-57354-2025-09-25)
- Akira ransomware — Tentative d’attaque déjouée en abusant d’un outil RMM (LOTL) sur un contrôleur de domaine; chiffrement stoppé par détection comportementale. Source: [Barracuda](https://fr.blog.barracuda.com/2025/09/25/soc-case-files-akira-ransomware-remote-management-tool)
- Cybercriminalité — « PureCoder » professionnalise le développement de malwares, selon les chercheurs. Source: [CYBER-SECURITE.FR](https://www.cyber-securite.fr/purecoder-developpeur-malware/)
- Italie — Le dispositif « Piracy Shield » étendu à tous les événements en direct, au-delà du sport. Source: [Clubic](https://www.clubic.com/actualite-580696-iptv-pirate-apres-le-football-un-nouveau-terrain-vise-par-cette-fameuse-arme-antipiratage.html)
- Allemagne — Plusieurs organisations (Refresco, KWG, Okuma Europe) signalent des cyberattaques, confirmées par médias et communiqués. Sources: [Lebensmittel Zeitung](https://www.lebensmittelzeitung.net/tech-logistik/nachrichten/cybersecurity-refresco-kaempft-mit-hacker-attacke-186845), [LR Online](https://www.lr-online.de/lausitz/senftenberg/hacker-in-senftenberg-kriminelle-erpressen-vermieter-kwg-nach-massivem-cyberangriff-78336325.html), [Okuma](https://www.okuma.co.jp/english/news/2025/250925.php)
...
## Conclusion
Deux signaux dominent: la fragilité de la chaîne d’approvisionnement (auto, aérien) et l’exploitation active de failles réseau (Cisco) appellent un resserrement immédiat des contrôles de tiers, des politiques de patching et de la supervision. Les acteurs malveillants privilégient les vecteurs « living off the land » et l’abus d’outils légitimes, ce qui impose une détection comportementale, une gestion stricte des accès et une hygiène MFA/mots de passe sans faille. Priorité à la remédiation Cisco, à la revue des dépendances critiques et aux plans de continuité pour limiter les effets dominos.

...
## Introduction courte
Bilan rapide des principaux faits du jour : arrestation liée à la cyberattaque ayant perturbé plusieurs aéroports européens, nouvelles fuites et impacts pour des entreprises françaises, record d’attaque DDoS remonté par Cloudflare, et émergence de menaces pilotées par IA.

## 🇫🇷 En France
- Bouygues Telecom — des millions de clients potentiellement concernés ; possibilité de vérifier la fuite via Have I Been Pwned, rapporté par [Numerama](https://www.numerama.com/cyberguerre/2081053-client-bouygues-verifiez-sur-ce-site-si-le-piratage-a-fait-fuiter-votre-iban-et-vos-donnees.html), [CommentCaMarche](https://www.commentcamarche.net/securite/piratage/35809-piratage-bouygues-telecom-vous-pouvez-savoir-si-vos-donnees-ont-ete-volees/).
- Stellantis — fuite de données confirmée suite à une attaque (probablement liée à un phishing sur Salesforce), signalée par [Data News / Le Vif](https://datanews.levif.be/actualite/securite/une-cyberattaque-provoque-une-fuite-de-donnees-chez-le-constructeur-automobile-stellantis/).
- Rempar25 / Cybermois 2025 — exercice français majeur sur la résilience face aux cyberattaques et rappel de l’importance du Cybermois, référencé dans la sélection quotidienne de [CyberLettre](https://cyberveille.curated.co/issues/405), mentionnant un article de [ZDNet](https://www.zdnet.fr/actualites/ce-que-revele-rempar25-sur-la-strategie-de-la-france-face-aux-cyberattaques-majeures-482583.htm).
- Constat sectoriel — rappel statistique partagé sur les réseaux : en 2024, « 1 entreprise française sur 2 a subi une cyberattaque », relayé via [bsky](https://bsky.app/profile/whaller.bsky.social/post/3lzl2qqjltk2z).

## 🌍 À l'international
- Arrestation liée à la cyberattaque ayant perturbé plusieurs aéroports européens — un quadragénaire interpellé au Royaume‑Uni dans le cadre des enquêtes sur les incidents affectant Collins Aerospace et plusieurs aéroports ; le rançongiciel HardBit est évoqué, couvert par [Clubic](https://www.clubic.com/actualite-580618-cyberattaque-des-aeroports-europeens-une-premiere-arrestation-a-eu-lieu.html), [LeMagIT](https://www.lemagit.fr/actualites/366632012/Cyberattaque-affectant-le-transport-aerien-europeen-une-arrestation-outre-Manche), [Le Figaro](https://www.lefigaro.fr/conjoncture/un-homme-arrete-au-royaume-uni-apres-la-cyberattaque-qui-perturbe-plusieurs-aeroports-europeens-20250924?utm_source=flipboard&utm_content=topic%2Ffr-cybercriminalit%C3%A9), [01net](https://www.01net.com/actualites/cyberattaque-contre-plusieurs-aeroports-europe-que-passe-weekend.html), [Data News / Le Vif](https://datanews.levif.be/actualite/securite/un-homme-interpelle-au-royaume-uni-apres-la-cyberattaque-ayant-perturbe-brussels-airport/), [ZDNet](https://www.zdnet.fr/actualites/aerien-europeen-perturbe-ce-ransomware-a-declenche-une-pagaille-sans-precedent-dans-plusieurs-pays-482583.htm).
- Cloudflare — nouvelle attaque DDoS record bloquée, pic à 22,2 térabits/s selon le rapport de [Cloudflare] relayé par [Numerama](https://www.numerama.com/cyberguerre/2081045-trois-semaines-plus-tard-lune-des-cyberattaques-les-plus-ambitieuses-de-tous-les-temps-revient-et-se-rate-a-nouveau.html).
- Ransomware 3.0 et IA — prototype de rançongiciel conçu et piloté intégralement par une IA, analysé par [IT Social](https://itsocial.fr/cybersecurite/cybersecurite-actualites/ransomware-3-0-anatomie-dune-attaque-automatisees-menee-de-bout-en-bout-par-lia/), repris dans la sélection de [CyberLettre](https://cyberveille.curated.co/issues/405).
- SolarWinds Web Help Desk — mention d’une vulnérabilité (CVE-2025-26399) permettant exécution de code à distance sur versions antérieures à 12.8.7 HF1, signalée dans le résumé de l’épisode RadioCSIRT ([RadioCSIRT](https://www.youtube.com/watch?v=bT65uYZSiys)).
...
## Conclusion
La journée confirme deux tendances : les incidents ciblant l’aérien continuent d’entraîner des mobilisations policières transnationales, et les fuites/attaques affectent toujours des acteurs majeurs (telecoms, constructeurs). Parallèlement, les menaces se complexifient (attaques DDoS massives, ransomware pilotés par IA). Restez vigilants et suivez les sources citées pour les mises à jour.

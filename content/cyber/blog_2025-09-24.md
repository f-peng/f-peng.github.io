...
<script>(function(){function r(){var a=document.querySelector('article.blog-content');if(!a)return;var s=a.querySelector('aside.toc-container');if(!s)return;var p=a.parentElement;if(!p||s.parentElement===p)return;p.insertBefore(s,a);}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',r);}else{r();}})();</script>

## Introduction
Ce billet couvre les faits saillants de la journée : une arrestation liée à la cyberattaque qui a perturbé plusieurs aéroports européens, des incidents affectant des acteurs français et internationaux, ainsi que la présence d’alertes CVE dans les flux consultés.

## 🇫🇷 En France
- Mise à jour du fichier Have I Been Pwned pour inclure l’incident touchant Bouygues Telecom et possibilité pour les clients de vérifier si leurs IBAN ou données ont fuité — [Numerama](https://www.numerama.com/cyberguerre/2081053-client-bouygues-verifiez-sur-ce-site-si-le-piratage-a-fait-fuiter-votre-iban-et-vos-donnees.html), [CommentCaMarche](https://www.commentcamarche.net/securite/piratage/35809-piratage-bouygues-telecom-vous-pouvez-savoir-si-vos-donnees-ont-ete-volees/).
- Fuite de données chez le constructeur Stellantis confirmée par la société, probable conséquence d’un phishing ciblant Salesforce — [DataNews / Levif](https://datanews.levif.be/actualite/securite/une-cyberattaque-provoque-une-fuite-de-donnees-chez-le-constructeur-automobile-stellantis/).
- Le retour sur l’exercice national « Rempar25 » et la stratégie française face aux cyberattaques majeures figure dans la veille du jour — [Votre CyberLettre (CyberLettre 405)](https://cyberveille.curated.co/issues/405).

## 🌍 À l’international
- Arrestation d’un quadragénaire au Royaume‑Uni dans le cadre de l’enquête sur la cyberattaque ayant perturbé plusieurs aéroports européens ; l’attaque aurait visé un logiciel d’enregistrement fourni par Collins Aerospace et le rançongiciel HardBit est évoqué par certains médias — [Le Figaro](https://www.lefigaro.fr/conjoncture/un-homme-arrete-au-royaume-uni-apres-la-cyberattaque-qui-perturbe-plusieurs-aeroports-europeens-20250924?utm_source=flipboard&utm_content=topic%2Ffr-cybercriminalit%C3%A9), [Clubic](https://www.clubic.com/actualite-580618-cyberattaque-des-aeroports-europeens-une-premiere-arrestation-a-eu-lieu.html), [LeMagIT](https://www.lemagit.fr/actualites/366632012/Cyberattaque-affectant-le-transport-aerien-europeen-une-arrestation-outre-Manche), [01net](https://www.01net.com/actualites/cyberattaque-contre-plusieurs-aeroports-europe-que-passe-weekend.html), [DataNews / Levif](https://datanews.levif.be/actualite/securite/un-homme-interpelle-au-royaume-uni-apres-la-cyberattaque-ayant-perturbe-brussels-airport/), [ZDNet](https://www.zdnet.fr/actualites/aerien-europeen-perturbe-ce-ransomware-a-declenche-une-pagaille-sans-precedent-dans-plusieurs-pays-482583.htm#xtor=RSS-1).
- Cloudflare indique avoir bloqué une attaque DDoS record culminant à 22,2 Tb/s — [Numerama](https://www.numerama.com/cyberguerre/2081045-trois-semaines-plus-tard-lune-des-cyberattaques-les-plus-ambitieuses-de-tous-les-temps-revient-et-se-rate-a-nouveau.html).
- Signalement d’un prototype de « ransomware 3.0 » conçu et opéré par une IA, première description d’une attaque entièrement automatisée — [Itsocial](https://itsocial.fr/cybersecurite/cybersecurite-actualites/ransomware-3-0-anatomie-dune-attaque-automatisees-menee-de-bout-en-bout-par-lia/), [Votre CyberLettre (CyberLettre 405)](https://cyberveille.curated.co/issues/405).

## Vulnérabilités critiques (CVSS ≥ 9)
- Aucune vulnérabilité critique (CVSS ≥ 9) n’est répertoriée dans les données fournies.

## Vulnérabilités élevées (7 ≤ CVSS < 9)
- Aucune vulnérabilité de sévérité élevée (7 ≤ CVSS < 9) n’est répertoriée dans les données fournies.

## Conclusion
La journée met en lumière à la fois l’impact opérationnel d’un ransomware sur le transport aérien européen et la montée d’incidents touchant des groupes et opérateurs en France. Les flux contiennent par ailleurs plusieurs alertes CVE (ex. D‑Link, Google Chrome, HPE Aruba, Linux, Mozilla) consultables dans la veille technique, mais sans scores CVSS fournis dans les éléments transmis. Vigilance et suivi des sources officielles restent recommandés.

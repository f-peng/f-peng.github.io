...
Ce vendredi 26 septembre 2025, la cybersécurité des infrastructures essentielles et des chaînes logistiques occupe le devant de la scène. Une cyberattaque massive a paralysé plusieurs aéroports européens, révélant une nouvelle fois la vulnérabilité des services tiers interconnectés. Pendant ce temps, le groupe de ransomware **Rhysida** revendique une attaque contre le département des transports du Maryland, avec des données mises en vente pour 3,4 millions de dollars. En France, les tensions persistent autour de **France Travail**, malgré un démenti officiel, tandis que la justice lyonnaise envoie un signal fort en condamnant lourdement les auteurs du piratage d’**Adecco**. Côté vulnérabilités, Cisco et Google Chrome figurent parmi les cibles prioritaires, sans qu’aucune faille critique ne soit signalée aujourd’hui.
...
- **Justice française** : le tribunal de Lyon prononce des peines sévères (jusqu’à 5 ans de prison) contre les auteurs du piratage d’**Adecco**, une affaire emblématique de cybercriminalité ciblant les ressources humaines, `[ZDNet](https://www.zdnet.fr/actualites/de-lourdes-peines-prononcees-au-proces-du-piratage-dadecco-482727.htm)`.
- **Check Point France** analyse dans une vidéo la cyberattaque ayant perturbé les aéroports européens, soulignant l’impact sur les systèmes d’enregistrement des bagages et d’embarquement, `[YouTube](https://www.youtube.com/shorts/qNX5IVt8KBg)`.

---

## 🌍 À l’international

- **Département des transports du Maryland (MDOT, États-Unis)** : le groupe **Rhysida** revendique le vol de données sensibles, exfiltrées et mises en vente pour 3,4 millions de dollars en Bitcoin, `[The Currency Analytics](https://fr.thecurrencyanalytics.com/bitcoin-fr/les-hackers-ciblent-le-departement-des-transports-du-maryland-vendent-des-donnees-pour-34-millions-de-dollars-en-bitcoin-200605)`.
- **Aéroports européens** (Bruxelles, Londres, Berlin) : une cyberattaque ciblant un **prestataire tiers** a provoqué des annulations massives de vols, avec une origine désormais attribuée à une faille dans un système de gestion partagé, `[01net](https://www.01net.com/actualites/cyberattaque-contre-plusieurs-aeroports-europe-que-passe-weekend.html)`, `[Siècle Digital](https://siecledigital.fr/2025/09/26/on-connait-desormais-lorigine-de-la-cyberattaque-qui-a-cloue-des-avions-au-sol/)`.
- **Thermofin (Allemagne)** : l’entreprise industrielle confirme une cyberattaque en cours, perturbant sa production et ses systèmes internes, `[Freie Presse](https://www.freiepresse.de/vogtland/reichenbach/vogtlaendisches-unternehmen-opfer-von-cyberangriff-wir-kaempfen-um-die-produktion-am-laufen-zu-halten-artikel13970410)`.
- **Elmar (Aruba)** : le fournisseur d’énergie et de télécommunications admet avoir subi une intrusion, sans préciser l’ampleur des dommages, `[Antilliaans Dagblad](https://antilliaansdagblad.com/nieuws-menu/aruba/31756-arubaanse-bedrijf-elmar-bevestigt-cyberaanval)`.
- **Crèche (localisation non précisée)** : les données personnelles de **8 000 enfants** ont été exfiltrées par des hackers, selon une révélation tardive, `[Prevention Internet](https://t.co/km80cKCYY1)`.
...
|--------------------------------|----------------|------------------------------------------------------------------------------------------------|
| **Cisco Secure Firewall** (ASA, FTD, IOS XE) | 8.6            | `[Cyberveille e-santé](https://cyberveille.esante.gouv.fr/alertes/cisco-cve-2025-20363-2025-09-26)` |
...
La journée du 26 septembre 2025 confirme deux tendances lourdes : **l’exposition croissante des infrastructures critiques** (transports, énergie) et **la persistance des attaques via la chaîne d’approvisionnement**. L’incident aérien européen rappelle douloureusement les risques liés aux dépendances externes, tandis que les vulnérabilités chez Cisco et Google Chrome exigent des correctifs urgents. En France, la vigilance reste de mise autour des données sensibles, comme en témoignent les rumeurs persistantes autour de France Travail. Pour les RSSI, la priorité doit porter sur **l’audit des prestataires tiers** et **la mise à jour des pare-feu et navigateurs**, deux vecteurs d’attaque récurrents. À suivre : l’évolution des investigations sur l’attaque du Maryland, qui pourrait révéler de nouvelles tactiques de monétisation des données volées.
...
- 🔗 Source: http://www.bing.com/news/apiclick.aspx?ref=FexRss&aid=&tid=68d7bbdbb55148d4aa54673fa10c3b6f&url=https%3a%2f%2ffr.thecurrencyanalytics.com%2fbitcoin-fr%2fles-hackers-ciblent-le-departement-des-transports-du-maryland-vendent-des-donnees-pour-34-millions-de-dollars-en-bitcoin-200605&c=10947965928362140217&mkt=fr-fr

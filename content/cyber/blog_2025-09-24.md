...
Bulletin du jour : fuites de données, perturbations dans le transport aérien européen et nouvelles attaques massives — l’écosystème reste sous pression.
...
- [🇫🇷 En France](#en-france)
- [🌍 À l'international](#a-l-international)
...
- Bouygues Telecom — fuite massive affectant près de 6 millions de clients ; possibilité de vérification via Have I Been Pwned. Sources : [Numerama](https://www.numerama.com/cyberguerre/2081053-client-bouygues-verifiez-sur-ce-site-si-le-piratage-a-fait-fuiter-votre-iban-et-vos-donnees.html), [CommentCaMarche](https://www.commentcamarche.net/securite/piratage/35809-piratage-bouygues-telecom-vous-pouvez-savoir-si-vos-donnees-ont-ete-volees/), [LaTribune](https://www.latribune.fr/article/tech/10198996893032/bouygues-telecom-pirate-les-clients-peuvent-desormais-verifier-si-leurs-donnees-ont-fuite?utm_source=flipboard&utm_content=topic%2Ffr-cybercriminalit%C3%A9)
- Stellantis — publication d’une fuite de données probablement liée à une campagne de phishing visant Salesforce. Source : [Data News / LeVif](https://datanews.levif.be/actualite/securite/une-cyberattaque-provoque-une-fuite-de-donnees-chez-le-constructeur-automobile-stellantis/)
- Initiatives nationales — lancement prochain du Cybermois 2025 et retour sur l’exercice national “Rempar25” axé sur un scénario de blackout numérique. Sources : [Whaller (Cybermois)](https://bsky.app/profile/whaller.bsky.social/post/3lzl2qqjltk2z), [CyberVeille - CyberLettre](https://cyberveille.curated.co/issues/405)

## 🌍 À l'international

- Arrestation liée aux cyberattaques ayant perturbé plusieurs aéroports européens — un suspect interpellé au Royaume‑Uni dans le cadre d’enquêtes sur des incidents ayant provoqué annulations et perturbations ; le rançongiciel HardBit est évoqué par certains articles. Sources : [LeMagIT](https://www.lemagit.fr/actualites/366632012/Cyberattaque-affectant-le-transport-aerien-europeen-une-arrestation-outre-Manche), [Clubic](https://www.clubic.com/actualite-580618-cyberattaque-des-aeroports-europeens-une-premiere-arrestation-a-eu-lieu.html), [BFMTV](https://www.bfmtv.com/international/europe/angleterre/un-homme-arrete-au-royaume-uni-apres-la-cyberattaque-ayant-perturbe-plusieurs-aeroports-europeens_AD-202509240543.html?utm_source=flipboard&utm_content=topic%2Ffr-cybercriminalit%C3%A9)
- Transport aérien — retombées opérationnelles importantes, Brussels Airport déploie un nouveau système d’enregistrement/embarquement pour reprendre la main. Sources : [01net](https://www.01net.com/actualites/cyberattaque-contre-plusieurs-aeroports-europe-que-passe-weekend.html), [LaLibre](https://www.lalibre.be/economie/entreprises-startup/2025/09/24/cyberattaque-brussels-airport-brussels-airport-deploie-un-nouveau-systeme-denregistrement-et-dembarquement-des-lundi-T5OGINLV3JDBHNMMOKTGOXHVJQ/?utm_source=flipboard&utm_content=topic%2Ffr-cybercriminalit%C3%A9)
- DDoS massif — Cloudflare aurait bloqué une attaque record culminant à 22,2 Tb/s, près du double du précédent sommet enregistré. Source : [Numerama](https://www.numerama.com/cyberguerre/2081045-trois-semaines-plus-tard-lune-des-cyberattaques-les-plus-ambitieuses-de-tous-les-temps-revient-et-se-rate-a-nouveau.html)
- Réseau malveillant démantelé — saisie de centaines de serveurs et ~100 000 cartes SIM dans une opération américaine visant un vaste réseau de dispositifs compromis. Sources : [MacGeneration](https://www.macg.co/ailleurs/2025/09/une-cyberattaque-sur-les-reseaux-cellulaires-new-yorkais-dejouee-100-000-cartes-sim-saisies-303921?utm_source=flipboard&utm_content=topic/fr-technologie), [CyberVeille - CyberLettre](https://cyberveille.curated.co/issues/405)
- Ransomware 3.0 — premières démonstrations d’un rançongiciel conçu et piloté intégralement par une IA, marqué comme prototype d’une menace automatisée. Source : [IT Social / ITSocial.fr](https://itsocial.fr/cybersecurite/cybersecurite-actualites/ransomware-3-0-anatomie-dune-attaque-automatisees-menee-de-bout-en-bout-par-lia/), mentionnée aussi dans la sélection [CyberVeille - CyberLettre](https://cyberveille.curated.co/issues/405)

## Vulnérabilités critiques (CVSS ≥ 9)

- Aucune vulnérabilité critique (CVSS ≥ 9) signalée dans les données reçues aujourd'hui.

## Vulnérabilités élevées (7 ≤ CVSS < 9)

- Aucune vulnérabilité élevée (7 ≤ CVSS < 9) signalée dans les données reçues aujourd'hui.

## Conclusion

Journée marquée par des incidents à fort impact opérationnel (transport aérien) et des fuites de données massives côté opérateurs et groupes industriels. La tendance demeure : diversification des méthodes d’attaque (IA, ransomware, DDoS) et nécessité de vigilance et de mises à jour rapides.

...
## Introduction
La journée est marquée par une double urgence : des vulnérabilités réseau Cisco exploitées activement et une nouvelle série d'incidents touchant la chaîne d'approvisionnement et des grands industriels, du constructeur automobile aux fournisseurs aéronautiques, mettant sous tension PME et opérateurs critiques.

## 🇫🇷 En France
- CERT‑FR — alerte sur l'exploitation active des vulnérabilités CVE‑2025‑20362 et CVE‑2025‑20333 affectant Cisco ASA et FTD, permettant l'exécution de code à distance ; [CERT‑FR Alerte](https://www.cert.ssi.gouv.fr/alerte/CERTFR-2025-ALE-013/), [CERT‑FR AVI‑0819](https://www.cert.ssi.gouv.fr/avis/CERTFR-2025-AVI-0819/).
- Cyberveille (esante.gouv.fr) — publication d'avis sur de multiples vulnérabilités touchant Cisco (CVE‑2025‑20334, CVE‑2025‑20352), Google Chrome (CVE‑2025‑10891), Microsoft OmniParser (CVE‑2025‑55322) et Node.js (CVE‑2025‑57354) ; [Cisco CVE‑2025‑20334](https://cyberveille.esante.gouv.fr/alertes/cisco-cve-2025-20334-2025-09-25), [Cisco CVE‑2025‑20352](https://cyberveille.esante.gouv.fr/alertes/cisco-cve-2025-20352-2025-09-25), [Google Chrome CVE‑2025‑10891](https://cyberveille.esante.gouv.fr/alertes/google-chrome-cve-2025-10891-2025-09-25), [Microsoft OmniParser CVE‑2025‑55322](https://cyberveille.esante.gouv.fr/alertes/microsoft-omniparser-cve-2025-55322-2025-09-25), [Node.js CVE‑2025‑57354](https://cyberveille.esante.gouv.fr/alertes/nodejs-cve-2025-57354-2025-09-25).
- Inovie Labosud — laboratoire médical français victime d'une cyberattaque signalée fin août, perturbant ses activités ; [Hérault Tribune](https://www.herault-tribune.com/articles/herault-le-laboratoire-medical-inovie-labosud-frappe-par-une-cyberattaque/).

## 🌍 À l’international
- Jaguar Land Rover (R.-U.) — cyberattaque massive ayant paralysé des usines ; le gouvernement britannique envisage d'acheter les pièces des sous‑traitants pour éviter l'effondrement de PME et protéger jusqu'à 200 000 emplois ; [Le Monde](https://www.lemonde.fr/economie/article/2025/09/25/cyberattaque-geante-contre-jaguar-land-rover-le-gouvernement-britannique-pret-a-soutenir-les-fournisseurs-du-constructeur-paralyse_6642916_3234.html).
- Volvo — fuite de données après compromission d'un fournisseur logiciel, exposant les données personnelles de milliers d'employés nord‑américains ; [01net](https://www.01net.com/actualites/apres-jaguar-land-rover-stellantis-volvo-victime-fuite-donnees.html).
- KnP Logistics Group (R.-U.) — transporteur fondé en 1867 a cessé ses activités après une cyberattaque liée à un mot de passe faible ; [Clubic](https://www.clubic.com/actualite-580699-apres-plus-de-150-ans-cette-societe-a-mis-la-cle-sous-la-porte-a-cause-d-un-mot-passe-trop-faible.html).
- Collins Aerospace / aéroports européens — une cyberattaque visant le fournisseur Collins Aerospace a perturbé plusieurs aéroports européens, causant retards et annulations ; [Numerama](https://www.numerama.com/cyberguerre/2078659-beaucoup-dans-le-secteur-sont-surpris-pourquoi-la-cyberattaque-des-aeroports-europeens-a-pris-une-telle-ampleur.html).
- Refresco (Allemagne) — entreprise affectée par une cyberattaque autour du 24 septembre 2025 selon des signalements sectoriels ; [Lebensmittelzeitung](https://www.lebensmittelzeitung.net/tech-logistik/nachrichten/cybersecurity-refresco-kaempft-mit-hacker-attacke-186845).
- Cisco (global) — correctifs publiés pour de multiples vulnérabilités d'IOS/IOS XE dont une faille zero‑day SNMP (CVE‑2025‑20352) signalée en exploitation ; [IT‑Connect](https://www.it-connect.fr/cisco-ios-13-vulnerabilites-dont-1-faille-zero-day-snmp/), [CERT‑FR AVI‑0818](https://www.cert.ssi.gouv.fr/avis/CERTFR-2025-AVI-0818/).
- Incident Akira (cas d'étude) — une attaque par ransomware Akira a exploité des outils de gestion à distance (RMM) pour déployer un runbook d'attaque, démontrant la menace "living off the land" et l'intérêt des capacités XDR pour la détection ; [Barracuda Blog](https://fr.blog.barracuda.com/2025/09/25/soc-case-files-akira-ransomware-remote-management-tool).
...
## Conclusion
La synthèse du jour met en lumière deux priorités convergentes : corriger en urgence les vulnérabilités critiques côté infrastructure réseau (alerte Cisco/CERT‑FR) et renforcer la résilience de la chaîne d'approvisionnement — tant pour prévenir les retombées industrielles que pour protéger les PME fournisseurs. Les incidents recensés soulignent enfin l'importance de la sécurisation des outils de management à distance, de la surveillance active (XDR/alerting) et de la gestion des dépendances fournisseurs comme axes opérationnels à prioriser.

...
## Introduction courte
Chaîne d’approvisionnement fragilisée, infrastructures perturbées et vulnérabilités activement exploitées: la journée illustre une pression soutenue sur l’écosystème numérique, du secteur automobile aux aéroports, tandis que les autorités françaises multiplient les alertes de sécurité.

## 🇫🇷 En France
- CERT-FR: alerte sur les vulnérabilités CVE-2025-20362 et CVE-2025-20333 activement exploitées sur Cisco ASA/FTD, permettant une exécution de code à distance sans authentification [CERT-FR](https://www.cert.ssi.gouv.fr/alerte/CERTFR-2025-ALE-013/), [CERT-FR (Mastodon)](https://social.numerique.gouv.fr/@cert_fr/115266136468526536), [CERT-FR (Bluesky)](https://bsky.app/profile/cert-fr.bsky.social/post/3lzoiebdbm62k).
- Inovie Labosud: le laboratoire médical a été frappé par une cyberattaque fin août, avec impacts opérationnels rapportés localement [Hérault Tribune](https://www.herault-tribune.com/articles/herault-le-laboratoire-medical-inovie-labosud-frappe-par-une-cyberattaque/), [ransomware.live](https://www.ransomware.live/#/recentcyberattacks).
- ANTS: une enquête médiatique remet en question les prétendues ventes massives de données d’état civil attribuées à l’agence [ZATAZ](https://cur.at/dCUWylR?m=rss).
- Réseaux mobiles: l’Arcep prépare l’extinction des réseaux 2G/3G en France, un basculement qui concernerait encore plusieurs millions de cartes SIM [servicesmobiles.fr](https://cur.at/xSrnUpK?m=rss).

## 🌍 À l’international
- Jaguar Land Rover: après une cyberattaque paralysante, Londres envisage de soutenir les fournisseurs pour éviter une casse sociale dans la filière automobile [Le Monde](https://www.lemonde.fr/economie/article/2025/09/25/cyberattaque-geante-contre-jaguar-land-rover-le-gouvernement-britannique-pret-a-soutenir-les-fournisseurs-du-constructeur-paralyse_6642916_3234.html).
- Volvo: fuite de données de milliers d’employés nord-américains après l’intrusion d’un fournisseur logiciel, symptôme de la montée des attaques supply chain [01net](https://www.01net.com/actualites/apres-jaguar-land-rover-stellantis-volvo-victime-fuite-donnees.html).
- KnP Logistics Group: ce transporteur britannique a cessé ses activités après une cyberattaque, illustrant la létalité économique de failles basiques [Clubic](https://www.clubic.com/actualite-580699-apres-plus-de-150-ans-cette-societe-a-mis-la-cle-sous-la-porte-a-cause-d-un-mot-passe-trop-faible.html).
- Aéroports européens: perturbations de vols après une attaque visant Collins Aerospace, avec éclairages sur l’ampleur et les motivations des assaillants [Numerama](https://www.numerama.com/cyberguerre/2078659-beaucoup-dans-le-secteur-sont-surpris-pourquoi-la-cyberattaque-des-aeroports-europeens-a-pris-une-telle-ampleur.html), [L'Usine Digitale](https://news.google.?oc=5).
- Akira ransomware: tentative d’intrusion stoppée après l’abus d’un outil de gestion à distance (RMM) pour se fondre dans l’IT légitime, cas d’école du “Living off the Land” [Barracuda](https://fr.blog.barracuda.com/2025/09/25/soc-case-files-akira-ransomware-remote-management-tool).
- Refresco (Allemagne): le géant des boissons signale une cyberattaque fin septembre, avec suivi par des observateurs du secteur [Lebensmittel Zeitung](https://www.lebensmittelzeitung.net/tech-logistik/nachrichten/cybersecurity-refresco-kaempft-mit-hacker-attacke-186845), [ransomware.live](https://www.ransomware.live/#/recentcyberattacks).
- Italie (Piracy Shield): l’outil de blocage antipiratage va s’étendre à tous les événements diffusés en direct, au-delà du sport [Clubic](https://www.clubic.com/actualite-580696-iptv-pirate-apres-le-football-un-nouveau-terrain-vise-par-cette-fameuse-arme-antipiratage.html).
- Tor Project: lancement d’un VPN expérimental pour Android, utilisant l’infrastructure du réseau Tor [Clubic](https://cur.at/gF8dGU2?m=rss).
...
## Conclusion
Les attaques par rebond sur la chaîne d’approvisionnement et les effets systémiques sur l’industrie et le transport dominent l’actualité, tandis que l’exploitation active de failles réseau met la pression sur les équipes de défense. Priorités immédiates: durcir la gestion des tiers, patcher en urgence les équipements exposés (notamment Cisco ASA/FTD) et surveiller l’usage d’outils légitimes (RMM, scripts) que les acteurs malveillants détournent pour rester sous les radars.

...
## Introduction
La journée est marquée par une arrestation liée à la cyberattaque qui a perturbé plusieurs aéroports européens, des fuites de données touchant des groupes français et des signaux forts d’escalade des menaces (DDoS record, rançongiciels pilotés par IA).

## 🇫🇷 En France
- Bouygues Telecom : le site Have I Been Pwned a été mis à jour pour inclure l’incident qui a exposé des millions de clients (IBANs et autres données) — [Numerama](https://www.numerama.com/cyberguerre/2081053-client-bouygues-verifiez-sur-ce-site-si-le-piratage-a-fait-fuiter-votre-iban-et-vos-donnees.html), [CommentCaMarche](https://www.commentcamarche.net/securite/piratage/35809-piratage-bouygues-telecom-vous-pouvez-savoir-si-vos-donnees-ont-ete-volees/).
- Stellantis : le constructeur annonce une fuite de données, possiblement liée à une attaque de phishing visant Salesforce — [DataNews / LeVif](https://datanews.levif.be/actualite/securite/une-cyberattaque-provoque-une-fuite-de-donnees-chez-le-constructeur-automobile-stellantis/).
- Rempar25 / préparation nationale : l’exercice « Rempar25 » sur un scénario de blackout numérique a réuni un grand nombre d’acteurs et est signalé comme un élément clé de la stratégie de résilience — [CyberLettre (curated)](https://cyberveille.curated.co/issues/405).

## 🌍 À l'international
- Arrestation au Royaume‑Uni liée à la cyberattaque ayant perturbé plusieurs aéroports européens (service d’enregistrement fourni par Collins Aerospace visé) ; un quadragénaire a été interpellé puis remis en liberté sous caution selon les comptes rendus — [Le Figaro](https://www.lefigaro.fr/conjoncture/un-homme-arrete-au-royaume-uni-apres-la-cyberattaque-qui-perturbe-plusieurs-aeroports-europeens-20250924?utm_source=flipboard&utm_content=topic%2Ffr-cybercriminalit%C3%A9), [LeMagIT](https://www.lemagit.fr/actualites/366632012/Cyberattaque-affectant-le-transport-aerien-europeen-une-arrestation-outre-Manche), [Clubic](https://www.clubic.com/actualite-580618-cyberattaque-des-aeroports-europeens-une-premiere-arrestation-a-eu-lieu.html), [01net](https://www.01net.com/actualites/cyberattaque-contre-plusieurs-aeroports-europe-que-passe-weekend.html), [ZDNet](https://www.zdnet.fr/actualites/aerien-europeen-perturbe-ce-ransomware-a-declenche-une-pagaille-sans-precedent-dans-plusieurs-pays-482583.htm#xtor=RSS-1).
- DDoS de très grande ampleur : Cloudflare a rapporté avoir bloqué une attaque culminant à 22,2 térabits/s — [Numerama](https://www.numerama.com/cyberguerre/2081045-trois-semaines-plus-tard-lune-des-cyberattaques-les-plus-ambitieuses-de-tous-les-temps-revient-et-se-rate-a-nouveau.html).
- Ransomware 3.0 / IA : un prototype de rançongiciel conçu, exécuté et piloté entièrement par une intelligence artificielle est décrit comme une menace émergente et automatisée — [Itsocial](https://itsocial.fr/cybersecurite/cybersecurite-actualites/ransomware-3-0-anatomie-dune-attaque-automatisees-menee-de-bout-en-bout-par-lia/), [CyberLettre (curated)](https://cyberveille.curated.co/issues/405).
...
## Conclusion
La tendance est claire : attaques impactant des infrastructures critiques (transport aérien), montée en puissance des capacités offensives (DDoS record) et évolution des outils d’attaque vers l’automatisation par IA. Côté France, les incidents de fuites massives de données continuent d’impacter des millions d’utilisateurs. Vigilance et renforcement des mesures de résilience restent indispensables.

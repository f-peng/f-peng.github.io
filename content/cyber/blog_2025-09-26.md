...
## Introduction courte
Une vague d’incidents rappelle la pression constante sur les chaînes d’approvisionnement et les équipements réseau: perturbations majeures dans plusieurs aéroports européens liées à un service tiers, alerte sur des zero-day visant des pare-feux Cisco, et données d’une administration américaine revendues par un groupe de ransomware. En France, France Travail dément une nouvelle fuite tandis qu’un procès emblématique aboutit à de lourdes condamnations.

## 🇫🇷 En France
- France Travail: l’organisme dément toute nouvelle fuite touchant 22,3 millions de personnes après enquête interne [01net](https://www.01net.com/actualites/france-travail-dement-avoir-subi-nouvelle-fuite-donnees.html).
- Adecco: la justice lyonnaise prononce de lourdes peines dans l’affaire de piratage, décision jugée emblématique [ZDNet](https://www.zdnet.fr/actualites/de-lourdes-peines-prononcees-au-proces-du-piratage-dadecco-482727.htm#xtor=RSS-1).

## 🌍 À l’international
- Brussels Airport et plusieurs aéroports européens: perturbations massives (enregistrement bagages/embarquement) liées à la compromission d’un service tiers [01net](https://www.01net.com/actualites/cyberattaque-contre-plusieurs-aeroports-europe-que-passe-weekend.html), [Siècle Digital](https://siecledigital.fr/2025/09/26/on-connait-desormais-lorigine-de-la-cyberattaque-qui-a-cloue-des-avions-au-sol/).
- Cisco: campagne ArcaneDoor exploitant des zero-day contre des pare-feux et équipements réseau, alerte aux clients [Usine Digitale](https://www.usine-digitale.fr/article/cisco-alerte-sur-une-campagne-de-cyberespionnage-ciblant-ses-equipements-reseau.N2238494).
- Maryland Department of Transportation (MDOT): le groupe Rhysida revendique la vente de données pour 3,4 M$ en bitcoin [The Currency Analytics (FR)](https://fr.thecurrencyanalytics.com/bitcoin-fr/les-hackers-ciblent-le-departement-des-transports-du-maryland-vendent-des-donnees-pour-34-millions-de-dollars-en-bitcoin-200605).
- Thermofin (Allemagne): entreprise industrielle touchée par une cyberattaque, production sous tension [Valéry Marchive (Bluesky)](https://bsky.app/profile/valerymarchive.bsky.social/post/3lzpv6vs2pp2t).
- Burrillville School Department (États-Unis): confirmation d’une cyberattaque affectant un lycée [Valéry Marchive (Bluesky)](https://bsky.app/profile/valerymarchive.bsky.social/post/3lzpuyxdshi2c).
...
| --- | --- | --- |
| Cisco Secure Firewall ASA/FTD, IOS/IOS XE/IOS XR – CVE-2025-20363 | score non communiqué | [Cyberveille e-santé](https://cyberveille.esante.gouv.fr/alertes/cisco-cve-2025-20363-2025-09-26) |
| Google Chrome (V8) – CVE-2025-10892 | score non communiqué | [Cyberveille e-santé](https://cyberveille.esante.gouv.fr/alertes/google-chrome-cve-2025-10892-2025-09-26) |
| Nagios (assistants DB: MongoDB/MySQL/Postgres) – CVE-2025-34227 | score non communiqué | [Cyberveille e-santé](https://cyberveille.esante.gouv.fr/alertes/nagios-cve-2025-34227-2025-09-26) |

## Conclusion
La semaine confirme deux dynamiques fortes: l’exposition systémique via des prestataires critiques (aéroports) et l’exploitation d’équipements réseau pour l’accès initial (campagne ArcaneDoor). Priorités opérationnelles: cartographier et isoler les dépendances clés de la supply chain, appliquer sans délai les correctifs/mitigations sur Cisco et Chrome, et renforcer la détection sur les interfaces web d’administration. En France, la vigilance s’impose face aux revendications de fuites non corroborées, tandis que la réponse judiciaire se durcit sur les affaires de piratage.

...
## Introduction
Brève revue des principales actualités cybersécurité collectées le 24 septembre 2025 : attaques contre le transport aérien européen, fuites de données, records d’attaques DDoS et alertes techniques publiées par la cyberveille française.

## 🇫🇷 En France
- Bouygues Telecom : mise à jour du service Have I Been Pwned pour inclure l’incident de cet été ; des millions de clients peuvent vérifier si leurs IBAN et données ont fuité — [Numerama](https://www.numerama.com/cyberguerre/2081053-client-bouygues-verifiez-sur-ce-site-si-le-piratage-a-fait-fuiter-votre-iban-et-vos-donnees.html), [CommentCaMarche](https://www.commentcamarche.net/securite/piratage/35809-piratage-bouygues-telecom-vous-pouvez-savoir-si-vos-donnees-ont-ete-volees/).
- Perturbations dans le transport aérien européen : un quadragénaire arrêté au Royaume‑Uni dans le cadre de l’enquête sur la cyberattaque ayant affecté plusieurs aéroports ; le rançongiciel HardBit est évoqué dans certaines enquêtes, et les perturbations ont entraîné annulations et chaos dans plusieurs grandes plateformes européennes — [LeMagIT](https://www.lemagit.fr/actualites/366632012/Cyberattaque-affectant-le-transport-aerien-europeen-une-arrestation-outre-Manche), [Clubic](https://www.clubic.com/actualite-580618-cyberattaque-des-aeroports-europeens-une-premiere-arrestation-a-eu-lieu.html), [01net](https://www.01net.com/actualites/cyberattaque-contre-plusieurs-aeroports-europe-que-passe-weekend.html), [Le Figaro](https://www.lefigaro.fr/conjoncture/un-homme-arrete-au-royaume-uni-apres-la-cyberattaque-qui-perturbe-plusieurs-aeroports-europeens-20250924?utm_source=flipboard&utm_content=topic%2Ffr-cybercriminalit%C3%A9), [ZDNet](https://www.zdnet.fr/actualites/aerien-europeen-perturbe-ce-ransomware-a-declenche-une-pagaille-sans-precedent-dans-plusieurs-pays-482583.htm#xtor=RSS-1).
- Stellantis : le constructeur signale une fuite de données, probablement liée à une campagne de phishing ciblant Salesforce — [Data News](https://datanews.levif.be/actualite/securite/une-cyberattaque-provoque-une-fuite-de-donnees-chez-le-constructeur-automobile-stellantis/).
- Alertes publiées par la cyberveille française : plusieurs bulletins techniques ont été mis en ligne concernant des vulnérabilités affectant D‑Link, Google Chrome (moteur V8), HPE Aruba (EdgeConnect OS), le noyau Linux et des produits Mozilla — [Cyberveille (D‑Link CVE-2025-57637)](https://cyberveille.esante.gouv.fr/alertes/d-link-cve-2025-57637-2025-09-24), [Cyberveille (Google Chrome CVE-2025-10890)](https://cyberveille.esante.gouv.fr/alertes/google-chrome-cve-2025-10890-2025-09-24), [Cyberveille (HPE Aruba CVE-2025-37125)](https://cyberveille.esante.gouv.fr/alertes/hpe-aruba-cve-2025-37125-2025-09-24), [Cyberveille (Linux CVE-2025-39869)](https://cyberveille.esante.gouv.fr/alertes/linux-cve-2025-39869-2025-09-24), [Cyberveille (Mozilla CVE-2025-10528)](https://cyberveille.esante.gouv.fr/alertes/mozilla-cve-2025-10528-2025-09-24).

## 🌍 À l’international
- Cloudflare : nouvelle attaque DDoS record bloquée, avec un pic rapporté à 22,2 térabits par seconde — [Numerama](https://www.numerama.com/cyberguerre/2081045-trois-semaines-plus-tard-lune-des-cyberattaques-les-plus-ambitieuses-de-tous-les-temps-revient-et-se-rate-a-nouveau.html).
- Ransomware 3.0 : publication d’une analyse sur un prototype expérimental de rançongiciel conçu, exécuté et piloté entièrement par une IA, soulignant l’émergence de menaces automatisées et polymorphes — [iTSocial](https://itsocial.fr/cybersecurite/cybersecurite-actualites/ransomware-3-0-anatomie-dune-attaque-automatisees-menee-de-bout-en-bout-par-lia/).
- Synthèse et veille : bulletins et newsletters spécialisés continuent d’alerter sur des campagnes de phishing, des attaques de la chaîne d’approvisionnement et des incidents touchant des groupes internationaux ; compilation et liens utiles disponibles dans la sélection du jour — [Votre CyberLettre (Cyberveille curated)](https://cyberveille.curated.co/issues/405).
- Bulletin RadioCSIRT : résumé audio des actualités cybersécurité incluant notamment un signalement sur SolarWinds Web Help Desk (CVE mentionnée dans l’épisode) — [RadioCSIRT - YouTube](https://www.youtube.com/watch?v=bT65uYZSiys).

## Vulnérabilités critiques (CVSS ≥ 9)
- Aucune vulnérabilité classée critique (CVSS ≥ 9) répertoriée dans les données fournies.

## Vulnérabilités élevées (7 ≤ CVSS < 9)
- Aucune vulnérabilité classée élevée (7 ≤ CVSS < 9) répertoriée dans les données fournies.

## Conclusion
Journée marquée par des incidents à fort impact opérationnel (transport aérien), des fuites de données touchant des acteurs majeurs et des signes d’escalade technique (IA et DDoS massifs). Surveillez les bulletins officiels cités ci‑dessus pour les recommandations techniques et les mises à jour.

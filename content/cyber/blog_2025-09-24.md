...
## Introduction
Bulletin du jour : arrestations liées à une vaste perturbation dans le transport aérien européen, nouvelles fuites et incidents chez des acteurs français, records et menaces à l'international, et plusieurs alertes CVE publiées ce 24 septembre 2025.

## 🇫🇷 En France
- Bouygues Telecom : des millions de clients potentiellement impactés par une fuite de données ; le site Have I Been Pwned a été mis à jour pour inclure l’incident (vérification possible pour les abonnés). [Numerama](https://www.numerama.com/cyberguerre/2081053-client-bouygues-verifiez-sur-ce-site-si-le-piratage-a-fait-fuiter-votre-iban-et-vos-donnees.html), [CommentCaMarche](https://www.commentcamarche.net/securite/piratage/35809-piratage-bouygues-telecom-vous-pouvez-savoir-si-vos-donnees-ont-ete-volees/), [La Tribune](https://www.latribune.fr/article/tech/10198996893032/bouygues-telecom-pirate-les-clients-peuvent-desormais-verifier-si-leurs-donnees-ont-fuite?utm_source=flipboard&utm_content=topic%2Ffr-cybercriminalit%C3%A9)
- Stellantis : le constructeur annonce une fuite de données, possiblement liée à des campagnes de phishing sur des services cloud (mention par les médias). [DataNews / Levif](https://datanews.levif.be/actualite/securite/une-cyberattaque-provoque-une-fuite-de-donnees-chez-le-constructeur-automobile-stellantis/)
- Rempar25 / préparation et résilience : retour sur l’exercice national axé sur un « blackout » numérique et ses enseignements (enjeux pour la stratégie nationale). [Votre CyberLettre / Cyberveille (récapitulatif citant zdnet)](https://cyberveille.curated.co/issues/405)

## 🌍 À l'international
- Arrestation liée à la cyberattaque ayant perturbé plusieurs aéroports européens (annulations et chaos opérationnel) : un quadragénaire interpellé au Royaume‑Uni dans le cadre des enquêtes sur l’incident. Le rançongiciel HardBit est cité par certaines sources. [Clubic](https://www.clubic.com/actualite-580618-cyberattaque-des-aeroports-europeens-une-premiere-arrestation-a-eu-lieu.html), [LeMagIT](https://www.lemagit.fr/actualites/366632012/Cyberattaque-affectant-le-transport-aerien-europeen-une-arrestation-outre-Manche), [01net](https://www.01net.com/actualites/cyberattaque-contre-plusieurs-aeroports-europe-que-passe-weekend.html), [BFMTV](https://www.bfmtv.com/international/europe/angleterre/un-homme-arrete-au-royaume-uni-apres-la-cyberattaque-ayant-perturbe-plusieurs-aeroports-europeens_AD-202509240543.html?utm_source=flipboard&utm_content=topic%2Ffr-cybercriminalit%C3%A9)
- Cloudflare : nouvelle attaque DDoS massive bloquée, pic annoncé à 22,2 Tb/s (nouveau record déclaré par l’entreprise). [Numerama](https://www.numerama.com/cyberguerre/2081045-trois-semaines-plus-tard-lune-des-cyberattaques-les-plus-ambitieuses-de-tous-les-temps-revient-et-se-rate-a-nouveau.html)
- Démantèlement d’un réseau visant les réseaux cellulaires new‑yorkais : saisie de dispositifs et de cartes SIM (opération des autorités américaines). [MacGeneration](https://www.macg.co/ailleurs/2025/09/une-cyberattaque-sur-les-reseaux-cellulaires-new-yorkais-dejouee-100-000-cartes-sim-saisies-303921?utm_source=flipboard&utm_content=topic/fr-technologie)
- Ransomware 3.0 : description d’un prototype de rançongiciel conçu et piloté intégralement par une IA, alarmant pour la trajectoire des menaces automatisées. [IT Social](https://itsocial.fr/cybersecurite/cybersecurite-actualites/ransomware-3-0-anatomie-dune-attaque-automatisees-menee-de-bout-en-bout-par-lia/)
- Alertes CVE publiées (exemples signalés) : D‑Link (CVE‑2025‑57637), Google Chrome / V8 (CVE‑2025‑10890), HPE Aruba (CVE‑2025‑37125), Linux kernel (CVE‑2025‑39869), Mozilla (CVE‑2025‑10528). Sources d’alerte présentes dans le flux d’alertes. [D‑Link (cyberveille)](https://cyberveille.esante.gouv.fr/alertes/d-link-cve-2025-57637-2025-09-24), [Google Chrome (cyberveille)](https://cyberveille.esante.gouv.fr/alertes/google-chrome-cve-2025-10890-2025-09-24), [HPE Aruba (cyberveille)](https://cyberveille.esante.gouv.fr/alertes/hpe-aruba-cve-2025-37125-2025-09-24), [Linux (cyberveille)](https://cyberveille.esante.gouv.fr/alertes/linux-cve-2025-39869-2025-09-24), [Mozilla (cyberveille)](https://cyberveille.esante.gouv.fr/alertes/mozilla-cve-2025-10528-2025-09-24)

## Vulnérabilités critiques (CVSS ≥ 9)
- Aucune vulnérabilité critique (CVSS ≥ 9) explicitement signalée dans les données fournies.

## Vulnérabilités élevées (7 ≤ CVSS < 9)
- Aucune vulnérabilité élevée (7 ≤ CVSS < 9) explicitement signalée dans les données fournies.

## Conclusion
La journée confirme une double tendance : incidents opérationnels d’ampleur (transport aérien, fuites massives de données) et évolution rapide des vecteurs d’attaque (automatisation/IA, records DDoS). Sur la base des éléments fournis, aucune CVE n’est classée ici comme critique ou élevée (scores CVSS non fournis dans les données) — priorité aux mises à jour et à la vérification des fuites pour les organisations et particuliers affectés.

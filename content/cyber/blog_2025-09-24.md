...
<script>(function(){function r(){var a=document.querySelector('article.blog-content');if(!a)return;var s=a.querySelector('aside.toc-container');if(!s)return;var p=a.parentElement;if(!p)return;var n=a.nextSibling;while(n&&n.nodeType!==1){n=n.nextSibling;}if(s.parentElement===p&&n===s){return;}if(n){p.insertBefore(s,n);}else{p.appendChild(s);}s.removeAttribute('style');}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',r);}else{r();}})();</script>

## Introduction
Bulletin du jour : phishing, fuites de données et perturbations majeures dans le transport aérien européen dominent l'actualité, tandis que plusieurs alertes CVE sont signalées sans score CVSS public dans les données fournies.

## 🇫🇷 En France
- Une mise à jour de la base Have I Been Pwned inclut l'incident ayant touché Bouygues Telecom cet été : des millions de clients potentiellement concernés, possibilité de vérifier la fuite (IBAN et données personnelles). [Numerama](https://www.numerama.com/cyberguerre/2081053-client-bouygues-verifiez-sur-ce-site-si-le-piratage-a-fait-fuiter-votre-iban-et-vos-donnees.html), [CommentCaMarche](https://www.commentcamarche.net/securite/piratage/35809-piratage-bouygues-telecom-vous-pouvez-savoir-si-vos-donnees-ont-ete-volees/).
- Le groupe automobile Stellantis signale une fuite de données probablement liée à une campagne de phishing visant des comptes Salesforce ; l'incident survient peu après une attaque similaire contre Jaguar Land Rover. [DataNews / LeVif](https://datanews.levif.be/actualite/securite/une-cyberattaque-provoque-une-fuite-de-donnees-chez-le-constructeur-automobile-stellantis/).
- L'exercice national "Rempar25" (simulation d'un blackout numérique) et le lancement imminent du CyberMois soulignent la mobilisation et la sensibilisation en France. [Votre CyberLettre](https://cyberveille.curated.co/issues/405).

## 🌍 À l’international
- Un quadragénaire a été interpellé au Royaume-Uni dans le cadre de l'enquête sur la cyberattaque ayant perturbé plusieurs aéroports européens ; l'attaque, attribuée au rançongiciel HardBit selon certains éléments, a provoqué annulations et chaos dans plusieurs pays. [LeMagIT](https://www.lemagit.fr/actualites/366632012/Cyberattaque-affectant-le-transport-aerien-europeen-une-arrestation-outre-Manche), [Clubic](https://www.clubic.com/actualite-580618-cyberattaque-des-aeroports-europeens-une-premiere-arrestation-a-eu-lieu.html), [Le Figaro](https://www.lefigaro.fr/conjoncture/un-homme-arrete-au-royaume-uni-apres-la-cyberattaque-qui-perturbe-plusieurs-aeroports-europeens-20250924?utm_source=flipboard&utm_content=topic%2Ffr-cybercriminalit%C3%A9).
- Cloudflare annonce avoir bloqué une attaque DDoS record culminant à 22,2 térabits/s, près du double du précédent pic quelques semaines plus tôt. [Numerama](https://www.numerama.com/cyberguerre/2081045-trois-semaines-plus-tard-lune-des-cyberattaques-les-plus-ambitieuses-de-tous-les-temps-revient-et-se-rate-a-nouveau.html).
- Émergence de menaces autonomes : un rançongiciel "3.0" conçu et piloté par une IA est décrit dans une analyse qui alerte sur l'automatisation complète des attaques. [Itsocial](https://itsocial.fr/cybersecurite/cybersecurite-actualites/ransomware-3-0-anatomie-dune-attaque-automatisees-menee-de-bout-en-bout-par-lia/).
- Le bulletin RadioCSIRT signale également une vulnérabilité affectant SolarWinds Web Help Desk (CVE-2025-26399) mentionnée dans son épisode du jour. [RadioCSIRT (YouTube)](https://www.youtube.com/watch?v=bT65uYZSiys).

## Vulnérabilités critiques (CVSS ≥ 9)
- Aucune vulnérabilité critique (CVSS ≥ 9) identifiée dans les données fournies.

## Vulnérabilités élevées (7 ≤ CVSS < 9)
- Aucune vulnérabilité classée de gravité élevée (CVSS 7–8.9) identifiée dans les données fournies.
- Alertes CVE signalées dans les sources fournies (CVSS non renseigné dans les éléments fournis) :
  - D-Link — CVE-2025-57637 (défaut de contrôle de la mémoire dans le service jhttpd) — CVSS : non renseigné. [Cyberveille / eSanté.gouv.fr](https://cyberveille.esante.gouv.fr/alertes/d-link-cve-2025-57637-2025-09-24)
  - Google Chrome (moteur V8) — CVE-2025-10890 (lecture de données via page forgée) — CVSS : non renseigné. [Cyberveille / eSanté.gouv.fr](https://cyberveille.esante.gouv.fr/alertes/google-chrome-cve-2025-10890-2025-09-24)
  - HPE Aruba (EdgeConnect OS) — CVE-2025-37125 (contournement de contrôles d’accès pare-feu) — CVSS : non renseigné. [Cyberveille / eSanté.gouv.fr](https://cyberveille.esante.gouv.fr/alertes/hpe-aruba-cve-2025-37125-2025-09-24)
  - Linux (noyau) — CVE-2025-39869 (défaut de gestion mémoire dans em_edma_setup_from_hw()) — CVSS : non renseigné. [Cyberveille / eSanté.gouv.fr](https://cyberveille.esante.gouv.fr/alertes/linux-cve-2025-39869-2025-09-24)
  - Mozilla (Graphics: Canvas2D) — CVE-2025-10528 (exécution via page Web forgée) — CVSS : non renseigné. [Cyberveille / eSanté.gouv.fr](https://cyberveille.esante.gouv.fr/alertes/mozilla-cve-2025-10528-2025-09-24)
  - SolarWinds Web Help Desk — CVE-2025-26399 (exécution de code à distance signalée dans le bulletin RadioCSIRT) — CVSS : non renseigné. [RadioCSIRT (YouTube)](https://www.youtube.com/watch?v=bT65uYZSiys)

## Conclusion
La journée reste marquée par des incidents d'impact opérationnel (transport aérien, fuites massives de données) et par l'apparition de menaces automatisées. Plusieurs CVE ont été signalées dans les sources fournies, mais aucun score CVSS n'est précisé dans ces éléments : surveillez les avis des éditeurs pour les correctifs et appliquez les mesures de mitigation standard.

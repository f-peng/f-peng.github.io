...
## Introduction
La journée est marquée par une alerte CERT‑FR sur des failles Cisco activement exploitées et une série d’attaques impactant chaînes d’approvisionnement et services essentiels, du constructeur automobile aux laboratoires médicaux, soulignant la convergence des risques : vulnérabilités critiques non corrigées, compromissions via fournisseurs et exploitation d’outils légitimes.

## 🇫🇷 En France
- CERT‑FR signale l’exploitation active des vulnérabilités CVE‑2025‑20362 et CVE‑2025‑20333 affectant Cisco ASA et FTD, permettant l’exécution de code à distance par un attaquant non authentifié ; [CERT‑FR](https://www.cert.ssi.gouv.fr/alerte/CERTFR-2025-ALE-013/).  
- CERT‑FR publie également des avis sur de multiples vulnérabilités dans Cisco IOS et IOS XE, dont une faille SNMP activement exploitée, invitant au déploiement rapide des correctifs ; [CERT‑FR (AVI‑0818)](https://www.cert.ssi.gouv.fr/avis/CERTFR-2025-AVI-0818/), [IT‑Connect](https://www.it-connect.fr/cisco-ios-13-vulnerabilites-dont-1-faille-zero-day-snmp/).  
- Le groupe de biologie médicale Inovie Labosud a signalé un accès non autorisé pouvant concerner jusqu’à 3,2 millions de personnes dans l’Hérault, avec dépôt de plainte en cours ; [BFMTV](https://www.bfmtv.com/herault/cyberattaque-du-laboratoire-inovie-labosud-3-2-millions-d-heraultais-potentiellement-concernes_AD-202509250737.html).  
- Suite à la cyberattaque contre Bouygues Telecom le mois précédent, des conseils pratiques sont publiés pour vérifier l’exposition des données clients et limiter les risques de fraude post‑incident ; [Futura‑Sciences](https://www.futura-sciences.com/tech/actualites/cybersecurite-bouygues-telecom-pirate-savoir-si-vos-donnees-sont-mauvaises-mains-125879/#xtor=RSS-8).

## 🌍 À l’international
- Jaguar Land Rover paralysé par une cyberattaque : le gouvernement britannique envisage d’aider les fournisseurs pour éviter des ruptures d’approvisionnement qui menacent des centaines de milliers d’emplois ; [Le Monde](https://www.lemonde.fr/economie/article/2025/09/25/cyberattaque-geante-contre-jaguar-land-rover-le-gouvernement-britannique-pret-a-soutenir-les-fournisseurs-du-constructeur-paralyse_6642916_3234.html), [Boursier](https://www.boursier.com/actualites/economie/cyberattaque-contre-jaguar-land-rover-londres-reflechit-a-un-soutien-pour-les-fournisseurs-53484.html).  
- Volvo victime collatérale d’un ransomware via un fournisseur logiciel, entraînant la compromission de données personnelles de milliers d’employés nord‑américains ; [01net](https://www.01net.com/actualites/apres-jaguar-land-rover-stellantis-volvo-victime-fuite-donnees.html).  
- Une cyberattaque d’ampleur perturbe plusieurs aéroports européens après une compromission touchant Collins Aerospace, avec impact opérationnel sur les vols ; [L'Usine Digitale](https://news.google.?oc=5).  
- L’Agence du revenu du Canada (ARC) signale la compromission de plus de 881 000 numéros de téléphone d’utilisateurs, avec des adresses courriel également affectées selon le communiqué local ; [TVA Nouvelles](https://www.tvanouvelles.ca/2025/09/25/cyberattaque-plus-de-881-000-numeros-de-telephone-dutilisateurs-de-larc-pirates?utm_source=flipboard&utm_content=topic%2Ffr-cybercriminalit%C3%A9).  
- Check Point / analyses sectorielles mettent en lumière des acteurs comme "PureCoder" qui professionnalisent la création de malwares et alimentent l’écosystème cybercriminel mondial ; [CYBER‑SECURITE.FR](https://www.cyber-securite.fr/purecoder-developpeur-malware/).  
- Un cas d’attaque par ransomware (Akira) illustre l’usage d’outils de gestion à distance légitimes (RMM) pour propager et exécuter des charges utiles, confirmé par un retour d’expérience de Barracuda ; [Barracuda Blog](https://fr.blog.barracuda.com/2025/09/25/soc-case-files-akira-ransomware-remote-management-tool).  
- Le transporteur britannique KnP Logistics Group a cessé ses activités après une cyberattaque, illustrant l’impact durable des incidents sur l’économie d’entreprise ; [Clubic](https://www.clubic.com/actualite-580699-apres-plus-de-150-ans-cette-societe-a-mis-la-cle-sous-la-porte-a-cause-d-un-mot-passe-trop-faible.html).
...
## Conclusion
Les éléments publiés aujourd’hui confirment deux priorités : accélérer le déploiement des correctifs pour les vulnérabilités accessibles et activement exploitées (ex. Cisco) et renforcer la résilience de la chaîne d’approvisionnement — fournisseurs compromis et usages d’outils légitimes (RMM) restent des vecteurs majeurs d’intrusion. Les organisations doivent prioriser correctifs, segmentation, surveillance des outils de gestion à distance et plans d’intervention pour limiter l’impact opérationnel et la fuite de données.

...
## Introduction
La journée est marquée par une nouvelle vague d’incidents qui confirme deux tendances lourdes : la montée des attaques sur la chaîne d’approvisionnement et l’exploitation active de vulnérabilités réseau critiques. Pendant que des équipementiers et fournisseurs sont paralysés, les autorités publiques émettent des alertes et les chercheurs pointent une professionnalisation croissante des développeurs de malwares.

## 🇫🇷 En France
- CERT‑FR : alerte sur l’exploitation active de vulnérabilités affectant Cisco ASA et FTD (CVE‑2025‑20362, CVE‑2025‑20333), permettant l’exécution de code à distance, avec avis et guides de détection publiés par le CERT‑FR et le CERT‑FR/CERT‑SSi; [CERT‑FR – Alerte](https://www.cert.ssi.gouv.fr/alerte/CERTFR-2025-ALE-013/), [CERT‑FR – AVI‑0819](https://www.cert.ssi.gouv.fr/avis/CERTFR-2025-AVI-0819/), [CERT‑FR – AVI‑0818](https://www.cert.ssi.gouv.fr/avis/CERTFR-2025-AVI-0818/)
- Inovie Labosud (groupe de biologie médicale) : plainte déposée après un accès non autorisé exposant des données personnelles et médicales potentiellement de 3,2 millions d’habitants de l’Hérault; [BFMTV](https://www.bfmtv.com/herault/cyberattaque-du-laboratoire-inovie-labosud-3-2-millions-d-heraultais-potentiellement-concernes_AD-202509250737.html?utm_source=flipboard&utm_content=topic/fr-sciences)

## 🌍 À l’international
- Jaguar Land Rover : cyberattaque majeure paralysant la production, le gouvernement britannique envisage de soutenir les sous‑traitants pour éviter des faillites et préserver l’emploi; [Le Monde](https://www.lemonde.fr/economie/article/2025/09/25/cyberattaque-geante-contre-jaguar-land-rover-le-gouvernement-britannique-pret-a-soutenir-les-fournisseurs-du-constructeur-paralyse_6642916_3234.html)
- Volvo : fuite de données liée à une attaque par ransomware via un fournisseur logiciel, compromettant des milliers d’employés nord‑américains et illustrant le risque croissant sur la chaîne d’approvisionnement; [01net](https://www.01net.com/actualites/apres-jaguar-land-rover-stellantis-volvo-victime-fuite-donnees.html)
- KnP Logistics Group (R.-U.) : transporteur fondé en 1867 a cessé son activité après une cyberattaque exploitant notamment un mot de passe insuffisamment sécurisé; [Clubic](https://www.clubic.com/actualite-580699-apres-plus-de-150-ans-cette-societe-a-mis-la-cle-sous-la-porte-a-cause-d-un-mot-passe-trop-faible.html)
- Agence du revenu du Canada (ARC) : plus de 881 000 numéros de téléphone et 86 599 adresses courriel d’utilisateurs compromis suite à une cyberattaque; [TVA Nouvelles](https://www.tvanouvelles.ca/2025/09/25/cyberattaque-plus-de-881-000-numeros-de-telephone-dutilisateurs-de-larc-pirates?utm_source=flipboard&utm_content=topic%2Ffr-cybercriminalit%C3%A9)
- Aéroports européens / Collins Aerospace : perturbations et enquêtes liées à une attaque ciblant un fournisseur critique de l’aviation civile, analysées dans des synthèses de la veille sectorielle; [Cyberveille – Votre CyberLettre](https://cyberveille.curated.co/issues/406)
- Barracuda (étude) : description d’une attaque par le ransomware Akira qui a utilisé un outil de gestion à distance (RMM) pour déployer du code et chiffrer des fichiers, démontrant des techniques “living off the land”; [Barracuda Blog](https://fr.blog.barracuda.com/2025/09/25/soc-case-files-akira-ransomware-remote-management-tool)
- PureCoder : chercheur(s) décrivent un développeur de malwares professionnel qui contribue à la montée en puissance et à la professionnalisation du marché du malware; [Cyber‑Securite.fr](https://www.cyber-securite.fr/purecoder-developpeur-malware/)
- Autres incidents industriels signalés (ex. Refresco en Allemagne, annonces de victimes répertoriées) illustrant la dispersion géographique des attaques contre la supply chain; [Lebensmittelzeitung (relai)](https://www.lebensmittelzeitung.net/tech-logistik/nachrichten/cybersecurity-refresco-kaempft-mit-hacker-attacke-186845)
...
## Conclusion
La synthèse du jour confirme deux priorités : renforcer la résilience de la chaîne d’approvisionnement et corriger en urgence les vulnérabilités réseau jugées critiques (notamment sur les appliances VPN/pare‑feu), car elles sont désormais activement exploitées. Côté tactique, les attaques qui réutilisent des outils légitimes (RMM, agents de sauvegarde) et la professionnalisation des développeurs de malwares exigent une vigilance accrue sur la gouvernance des accès, la segmentation des environnements, la protection des sauvegardes et des plans de continuité pour les PME sous‑traitantes.

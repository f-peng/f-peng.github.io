...
Bulletin du jour : arrestation liée à la vaste perturbation des aéroports européens, mise à jour sur la fuite de données Bouygues, fuite déclarée chez Stellantis, nouvelles attaques massives et évolution des menaces (IA et DDoS).

## 🇫🇷 En France

- Mise à jour après le piratage de Bouygues Telecom : le site Have I Been Pwned a été mis à jour pour inclure l’incident et permettre aux clients de vérifier si leurs IBAN ou données ont fuité, impactant des millions d’abonnés [Numerama](https://www.numerama.com/cyberguerre/2081053-client-bouygues-verifiez-sur-ce-site-si-le-piratage-a-fait-fuiter-votre-iban-et-vos-donnees.html), [CommentCaMarche](https://www.commentcamarche.net/securite/piratage/35809-piratage-bouygues-telecom-vous-pouvez-savoir-si-vos-donnees-ont-ete-volees/).
- Fuite de données déclarée par Stellantis : le constructeur annonce une agression ayant provoqué une fuite, possiblement liée à une campagne de phishing sur Salesforce selon les premiers éléments rapportés [DataNews / LeVif](https://datanews.levif.be/actualite/securite/une-cyberattaque-provoque-une-fuite-de-donnees-chez-le-constructeur-automobile-stellantis/).
- Perturbations aériennes et droits des passagers : les vols annulés après la cyberattaque qui a affecté des services tiers ont entraîné des procédures manuelles d’embarquement ; un rappel des droits à compensation a été publié pour les passagers affectés [Euronews](http://fr.euronews.com/voyages/2025/09/24/votre-vol-annule-a-cause-dune-cyberattaque-voici-vos-droits-a-compensation), [ZDNet](https://www.zdnet.fr/actualites/aerien-europeen-perturbe-ce-ransomware-a-declenche-une-pagaille-sans-precedent-dans-plusieurs-pays-482583.htm).
- Exercice national et sensibilisation : retour sur l’exercice “Rempar25” et rappel du lancement du Cybermois 2025, initiatives visant à renforcer la résilience et la sensibilisation en France [Votre CyberLettre](https://cyberveille.curated.co/issues/405), [Whaller (post)](https://bsky.app/profile/whaller.bsky.social/post/3lzl2qqjltk2z).

## 🌍 À l’international

- Arrestation au Royaume‑Uni liée à la cyberattaque ayant perturbé plusieurs aéroports européens : un quadragénaire interpellé puis remis en liberté sous caution ; le rançongiciel HardBit est évoqué dans certaines sources [LeMagIT](https://www.lemagit.fr/actualites/366632012/Cyberattaque-affectant-le-transport-aerien-europeen-une-arrestation-outre-Manche), [Clubic](https://www.clubic.com/actualite-580618-cyberattaque-des-aeroports-europeens-une-premiere-arrestation-a-eu-lieu.html), [DataNews / LeVif](https://datanews.levif.be/actualite/securite/un-homme-interpelle-au-royaume-uni-apres-la-cyberattaque-ayant-perturbe-brussels-airport/).
- Nouveau record d’attaque DDoS bloquée par Cloudflare : une attaque ayant atteint un pic de 22,2 Tbps a été annoncée et contrée par l’entreprise spécialisée en sécurité cloud [Numerama](https://www.numerama.com/cyberguerre/2081045-trois-semaines-plus-tard-lune-des-cyberattaques-les-plus-ambitieuses-de-tous-les-temps-revient-et-se-rate-a-nouveau.html).
- Ransomware et IA : description d’un prototype expérimental de “ransomware 3.0” conçu, exécuté et piloté intégralement par une IA, illustrant l’émergence de menaces automatisées et polymorphes [Itsocial](https://itsocial.fr/cybersecurite/cybersecurite-actualites/ransomware-3-0-anatomie-dune-attaque-automatisees-menee-de-bout-en-bout-par-lia/).
- Autres impacts et enquêtes internationales : enquêtes en cours et conséquences pour le transport aérien et des groupes internationaux, avec des comptes‑rendus synthétiques dans plusieurs médias spécialisés [01net](https://www.01net.com/actualites/cyberattaque-contre-plusieurs-aeroports-europe-que-passe-weekend.html), [Le Figaro](https://www.lefigaro.fr/conjoncture/un-homme-arrete-au-royaume-uni-apres-la-cyberattaque-qui-perturbe-plusieurs-aeroports-europeens-20250924?utm_source=flipboard&utm_content=topic%2Ffr-cybercriminalit%C3%A9).

## Vulnérabilités critiques (CVSS ≥ 9)

- Aucune vulnérabilité critique (CVSS ≥ 9) n’a été identifiée dans les données fournies aujourd’hui.

## Vulnérabilités élevées (7 ≤ CVSS < 9)

- Aucune vulnérabilité élevée (7 ≤ CVSS < 9) n’a été identifiée dans les données fournies aujourd’hui.

## Conclusion

Journée marquée par des retombées opérationnelles (aéroports, constructeurs, opérateurs) et par des tendances lourdes : montée en puissance d’attaques massives (DDoS), et élévation du risque lié à l’automatisation/IA dans les rançongiciels. Restez vigilants et vérifiez les ressources officielles citées pour vos actions de remédiation.
...
L'attaque a perturbé l'enregistrement, obligeant le personnel de la compagnie aérienne à recourir à des options comme la rédaction manuelle des cartes d'embarquement ou l'utilisation d'ordinateurs portables de secours.

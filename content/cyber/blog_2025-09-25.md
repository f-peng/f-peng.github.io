...
## Introduction
La journée confirme une tendance marquée : attaques massives contre des industriels et des chaînes d'approvisionnement, exploitation de fournisseurs et outils légitimes, et alertes nationales sur des vulnérabilités déjà exploitées — un cocktail qui pousse autorités et entreprises à prioriser correctifs, résilience et soutien aux sous-traitants.

## 🇫🇷 En France
- Inovie Labosud — cyberattaque ayant potentiellement exposé des données personnelles de 3,2 millions d'Héraultais ; [BFMTV](https://www.bfmtv.com/herault/cyberattaque-du-laboratoire-inovie-labosud-3-2-millions-d-heraultais-potentiellement-concernes_AD-202509250737.html?utm_source=flipboard&utm_content=topic/fr-sciences).  
- CERT-FR — alerte sur l’exploitation active des vulnérabilités CVE-2025-20362 et CVE-2025-20333 affectant Cisco ASA/FTD et appel au déploiement urgent des correctifs ; [CERT-FR — Alerte](https://www.cert.ssi.gouv.fr/alerte/CERTFR-2025-ALE-013/), [CERT-FR — Avis](https://www.cert.ssi.gouv.fr/avis/CERTFR-2025-AVI-0819/).  
- Cisco / infrastructures françaises — publication d'avis techniques et de correctifs pour de multiples vulnérabilités Cisco impactant IOS et IOS XE, soulignant un risque opérationnel pour les réseaux d'entreprise ; [CERT-FR — Avis](https://www.cert.ssi.gouv.fr/avis/CERTFR-2025-AVI-0818/).  
- Check Point Research / PureCoder — mise en lumière d'un développeur de malwares « professionnel » signalé par Check Point et relayé localement, signalant la montée en qualité des outils cybercriminels ; [CYBER-SECURITE.FR](https://www.cyber-securite.fr/purecoder-developpeur-malware/).  
- Transition mobile — la préparation française à l’extinction de la 2G/3G est avancée et soulève des enjeux techniques et logistiques pour les opérateurs et utilisateurs ; [CyberLettre (Cyberveille)](https://cyberveille.curated.co/issues/406).

## 🌍 À l’international
- Jaguar Land Rover (Royaume‑Uni) — cyberattaque massive paralysant la production ; le gouvernement britannique envisage de soutenir les fournisseurs pour éviter l’effondrement de PME et la perte d’emplois. [Le Monde](https://www.lemonde.fr/economie/article/2025/09/25/cyberattaque-geante-contre-jaguar-land-rover-le-gouvernement-britannique-pret-a-soutenir-les-fournisseurs-du-constructeur-paralyse_6642916_3234.html)  
- Volvo (États‑Unis / multinational) — fuite de données suite à une attaque passant par un fournisseur logiciel, compromettant des informations personnelles de milliers d'employés nord‑américains. [01net](https://www.01net.com/actualites/apres-jaguar-land-rover-stellantis-volvo-victime-fuite-donnees.html)  
- KnP Logistics Group (Royaume‑Uni) — fermeture de l’entreprise fondée en 1867 après une cyberattaque liée à un mot de passe trop faible, illustrant l’impact économique local des intrusions. [Clubic](https://www.clubic.com/actualite-580699-apres-plus-de-150-ans-cette-societe-a-mis-la-cle-sous-la-porte-a-cause-d-un-mot-passe-trop-faible.html)  
- Agence du revenu du Canada (ARC) — compromission de plus de 881 000 numéros de téléphone et 86 599 adresses e‑mail d'utilisateurs selon les rapports initiaux. [TVA Nouvelles](https://www.tvanouvelles.ca/2025/09/25/cyberattaque-plus-de-881-000-numeros-de-telephone-dutilisateurs-de-larc-pirates?utm_source=flipboard&utm_content=topic%2Ffr-cybercriminalit%C3%A9)  
- Collins Aerospace / aéroports européens — incident ayant affecté plusieurs aéroports et entraîné retards et annulations, lié à une cyberattaque sur un fournisseur d'équipements critiques. [CyberLettre (Cyberveille) — numerama cité](https://cyberveille.curated.co/issues/406)  
- Refresco (Allemagne) — signalement d'une cyberattaque affectant le groupe d'embouteillage et logistique. [Lebensmittelzeitung](https://www.lebensmittelzeitung.net/tech-logistik/nachrichten/cybersecurity-refresco-kaempft-mit-hacker-attacke-186845)  
- Okuma Europe / industrie (Europe) — incident signalé par la maison-mère Okuma, évoquant une attaque ayant touché la filiale européenne. [Okuma — communiqué anglais](https://www.okuma.co.jp/english/news/2025/250925.php)  
- Akira ransomware / tactique RMM — analyse de Barracuda décrivant un filet d'attaque utilisant des outils de gestion à distance (RMM) pour déployer Akira et contourner les défenses. [Barracuda Blog](https://fr.blog.barracuda.com/2025/09/25/soc-case-files-akira-ransomware-remote-management-tool)
...
## Conclusion
La synthèse du jour met en évidence trois priorités : 1) sécuriser la chaîne d'approvisionnement et les accès fournisseurs (risque démontré par les impacts chez des constructeurs et multinationales), 2) déployer rapidement les correctifs et surveiller l'exploitation active de vulnérabilités (alerte CERT‑FR sur Cisco), et 3) renforcer les mesures basiques (gestion des mots de passe, segmentation, détection des usages légitimes détournés) pour réduire les conséquences opérationnelles des rançongiciels et incidents à grande échelle.

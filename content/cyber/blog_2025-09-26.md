...
<aside class="toc-container md:col-span-1 md:pl-8" style="display:none">
  ...
  <nav aria-label="Sommaire">
    <ul>
      <li><a href="#une-journee-sous-tension-cyberespionnage-aeroports-paralyses-et-donnees-sensibles-exposees">Une journée sous tension : cyberespionnage, aéroports paralysés et données sensibles exposées</a>
      </li>
...
```markdown
## Une journée sous tension : cyberespionnage, aéroports paralysés et données sensibles exposées

La cybersécurité a été mise à rude épreuve ce 26 septembre 2025, avec des incidents majeurs touchant des infrastructures critiques et des acteurs économiques. Une campagne de cyberespionnage ciblant les équipements Cisco, révélée par l’éditeur lui-même, rappelle les risques persistants des *zero-day* exploités à des fins géopolitiques. Dans le même temps, le secteur aérien européen subissait encore les contrecoups d’une attaque en cascade, dont l’origine – un prestataire tiers compromis – a finalement été confirmée par l’ENISA. En France, les rumeurs de fuites massives de données chez France Travail ont été démenties, mais une crèche a vu les données de 8 000 enfants exfiltrées, soulignant la vulnérabilité des structures moins protégées. Entre menaces sophistiquées et failles logicielles, la journée illustre l’urgence de renforcer les chaînes d’approvisionnement et les protocoles de réponse aux incidents.

---

## 🇫🇷 En France

- **France Travail** dément formellement une fuite de données concernant 22,3 millions de Français, après des allégations sur un forum criminel, et confirme l’absence de nouvelle compromission de ses systèmes.
  *[01net](https://www.01net.com/actualites/france-travail-dement-avoir-subi-nouvelle-fuite-donnees.html)*

- **Une crèche française** (non nommée) subit une cyberattaque entraînant le vol des données personnelles de 8 000 enfants, selon une révélation relayée par Prévention Internet.
  *[Prévention Web](https://t.co/km80cKCYY1)*

- **Justice** : Le tribunal de Lyon prononce des peines lourdes (jusqu’à 5 ans de prison) dans l’affaire du piratage d’**Adecco**, marquant une jurisprudence forte contre la cybercriminalité organisée.
...
- **Cisco** alerte sur **ArcaneDoor**, une campagne de cyberespionnage exploitant des *zero-day* dans ses pare-feux (ASA/FTD) pour cibler des organisations gouvernementales et industrielles.
  *[Usine Digitale](https://www.usine-digitale.fr/article/cisco-alerte-sur-une-campagne-de-cyberespionnage-ciblant-ses-equipements-reseau.N2238494)*

- **Secteur aérien européen** : L’**ENISA** confirme que la cyberattaque ayant paralysé les aéroports de Bruxelles, Londres et Berlin provient de la compromission d’un **prestataire tiers** critique, perturbant les systèmes d’enregistrement et d’embarquement.
  *[Siècle Digital](https://siecledigital.fr/2025/09/26/on-connait-desormais-lorigine-de-la-cyberattaque-qui-a-cloue-des-avions-au-sol/), [01net](https://www.01net.com/actualites/cyberattaque-contre-plusieurs-aeroports-europe-que-passe-weekend.html)*

- **Allemagne** : **Thermofin** (spécialiste des échangeurs thermiques) subit une cyberattaque le 23 septembre, perturbant sa production et ses opérations.
...
- **Aruba** : Le fournisseur d’énergie **Elmar** confirme une attaque survenue le 11 septembre, sans préciser l’impact sur les infrastructures critiques.
  *[Antilliaans Dagblad](https://antilliaansdagblad.com/nieuws-menu/aruba/31756-arubaanse-bedrijf-elmar-bevestigt-cyberaanval)*

- **États-Unis** :
  - **Burrillville School Department** (Rhode Island) victime d’une attaque le 24 septembre, affectant les systèmes du lycée local.
    *[Turn to 10](https://turnto10.com/news/local/burrillville-schools-confirm-cyberattack-on-high-school-sept-25-2025)*
  - **National Molding LLC** notifie une brèche de données survenue en août 2024, exposant des informations clients.
    *[Vermont AG](https://ago.vermont.gov/document/2025-09-19-national-molding-data-breach-notice-consumers)*
...
Ce 26 septembre 2025 restera marqué par deux dynamiques préoccupantes : **l’exploitation systématique des chaînes d’approvisionnement** (illustrée par les aéroports européens) et **le ciblage d’infrastructures critiques** via des *zero-day*, comme le révèle Cisco. Les vulnérabilités élevées dans des solutions largement déployées (Chrome, Nagios, Cisco) rappellent l’importance des mises à jour urgentes, tandis que les attaques contre des cibles moins protégées (crèches, écoles) soulignent un élargissement du spectre des menaces. Pour les organisations, la priorité doit désormais porter sur **l’audit des prestataires tiers** et **la détection précoce des intrusions**, deux maillons faibles encore trop souvent négligés. À suivre : l’évolution des investigations sur ArcaneDoor, qui pourrait révéler une campagne d’espionnage d’ampleur inédite.
...
- 🔗 Source: http://www.bing.com/news/apiclick.aspx?ref=FexRss&aid=&tid=68d7fc167314422c9e672490f82faf84&url=https%3a%2f%2fwww.usine-digitale.fr%2farticle%2fcisco-alerte-sur-une-campagne-de-cyberespionnage-ciblant-ses-equipements-reseau.N2238494&c=17624207017550047412&mkt=fr-fr

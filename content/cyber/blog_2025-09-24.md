...
## Introduction
La journée est marquée par une arrestation au Royaume‑Uni liée à une cyberattaque ayant perturbé plusieurs aéroports européens, des incidents de fuite de données et des signes d’escalade dans les techniques d’attaque (DDoS record, rançongiciels assistés par IA).

## 🇫🇷 En France
- Bouygues Telecom : mise à jour de la base Have I Been Pwned pour inclure l’incident ayant exposé des millions de clients (IBAN et autres données) — [Numerama](https://www.numerama.com/cyberguerre/2081053-client-bouygues-verifiez-sur-ce-site-si-le-piratage-a-fait-fuiter-votre-iban-et-vos-donnees.html), [CommentÇaMarche](https://www.commentcamarche.net/securite/piratage/35809-piratage-bouygues-telecom-vous-pouvez-savoir-si-vos-donnees-ont-ete-volees/).
- Stellantis : fuite de données confirmée par le constructeur, possible lien avec une campagne de phishing ciblant Salesforce — [DataNews / LeVif](https://datanews.levif.be/actualite/securite/une-cyberattaque-provoque-une-fuite-de-donnees-chez-le-constructeur-automobile-stellantis/).
- Alertes techniques publiées par Cyberveille (sélection) : D‑Link (CVE-2025-57637), Google Chrome (CVE-2025-10890), HPE Aruba (CVE-2025-37125), Linux noyau (CVE-2025-39869), Mozilla (CVE-2025-10528) — [Cyberveille (liste des alertes)](https://cyberveille.esante.gouv.fr/alertes/d-link-cve-2025-57637-2025-09-24), [Cyberveille (Google Chrome)](https://cyberveille.esante.gouv.fr/alertes/google-chrome-cve-2025-10890-2025-09-24), [Cyberveille (HPE Aruba)](https://cyberveille.esante.gouv.fr/alertes/hpe-aruba-cve-2025-37125-2025-09-24), [Cyberveille (Linux)](https://cyberveille.esante.gouv.fr/alertes/linux-cve-2025-39869-2025-09-24), [Cyberveille (Mozilla)](https://cyberveille.esante.gouv.fr/alertes/mozilla-cve-2025-10528-2025-09-24).
- Exercice national et préparation : compte‑rendu et synthèse d’actualité dans la CyberLettre du 24 septembre (rempar25 et autres sujets de résilience) — [CyberLettre](https://cyberveille.curated.co/issues/405).

## 🌍 À l'international
- Arrestation au Royaume‑Uni en lien avec la cyberattaque qui a perturbé plusieurs aéroports européens ; l’attaque aurait visé un logiciel d’enregistrement fourni par Collins Aerospace et le rançongiciel HardBit est évoqué par certaines sources — [Le Figaro](https://www.lefigaro.fr/conjoncture/un-homme-arrete-au-royaume-uni-apres-la-cyberattaque-qui-perturbe-plusieurs-aeroports-europeens-20250924?utm_source=flipboard&utm_content=topic%2Ffr-cybercriminalit%C3%A9), [Clubic](https://www.clubic.com/actualite-580618-cyberattaque-des-aeroports-europeens-une-premiere-arrestation-a-eu-lieu.html), [LeMagIT](https://www.lemagit.fr/actualites/366632012/Cyberattaque-affectant-le-transport-aerien-europeen-une-arrestation-outre-Manche), [01net](https://www.01net.com/actualites/cyberattaque-contre-plusieurs-aeroports-europe-que-passe-weekend.html), [DataNews / LeVif](https://datanews.levif.be/actualite/securite/un-homme-interpelle-au-royaume-uni-apres-la-cyberattaque-ayant-perturbe-brussels-airport/).
- DDoS record bloqué par Cloudflare : attaque atteignant un pic de 22,2 térabits/s, selon l’entreprise — [Numerama](https://www.numerama.com/cyberguerre/2081045-trois-semaines-plus-tard-lune-des-cyberattaques-les-plus-ambitieuses-de-tous-les-temps-revient-et-se-rate-a-nouveau.html).
- Rançongiciel et innovations menaçantes : évocation d’un rançongiciel « 3.0 » conçu et piloté par IA — [ITsocial](https://itsocial.fr/cybersecurite/cybersecurite-actualites/ransomware-3-0-anatomie-dune-attaque-automatisees-menee-de-bout-en-bout-par-lia/).

## Vulnérabilités critiques (CVSS ≥ 9)
- Aucune vulnérabilité critique répertoriée dans les données fournies.

## Vulnérabilités élevées (7 ≤ CVSS < 9)
- Aucune vulnérabilité élevée répertoriée dans les données fournies.

## Conclusion
La période reste agitée : perturbations majeures du transport aérien liées à une compromission de service tiers, nouveaux records d’attaques DDoS et des évolutions inquiétantes autour de rançongiciels assistés par IA. Sur le volet technique, plusieurs alertes CVE ont été publiées par Cyberveille ; il convient aux équipes de sécurité de vérifier leurs systèmes et correctifs.

## Pour aller plus loin ...

<h3 class="class_h3">Un homme arrêté au Royaume-Uni après la cyberattaque qui perturbe plusieurs aéroports européens</h3>
- 📅 Wed, 24 Sep 2025 05:24:00 GMT
- 🔗 Source: http://www.bing.com/news/apiclick.aspx?ref=FexRss&aid=&tid=68d5a04b39be44c9abe73b1504d80711&url=https%3a%2f%2fwww.lefigaro.fr%2fconjoncture%2fun-homme-arrete-au-royaume-uni-apres-la-cyberattaque-qui-perturbe-plusieurs-aeroports-europeens-20250924&c=12179194943196452783&mkt=fr-fr

Les perturbations dans ces aéroports ont débuté samedi matin après qu’une cyberattaque a visé un logiciel pour l’enregistrement des passagers et des bagages fourni par la société Collins Aerospace.
